  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      instance = WS.create({
        ...
        url,
        height,
        waveColor: getComputedStyle(document.documentElement).getPropertyValue("--color-muted").trim() + "33",
        progressColor: getComputedStyle(document.documentElement).getPropertyValue("--color-accent").trim(),
        cursorWidth: 0,
        barWidth: 2,
        barGap: 2,
        barRadius: 2,
